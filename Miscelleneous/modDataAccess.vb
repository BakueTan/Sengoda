...
Public Module modDataAccess
    ...
    Public Sub OpenConnection(Optional ByVal planB As Boolean = False, Optional ByVal planC As Boolean = False,
    ...
    Public Function ConnectionString() As String
        Dim strCnn$ = ""
        Dim cnn As New clsDbConn
        Try
            strCnn = cnn.CnnString
        Catch ex As Exception
        End Try
        Return strCnn
    End Function
    ...
    Public Function ExecuteReader(ByVal sql As String, Optional ByVal PlanB As Boolean = False, Optional ByVal PlanC As Boolean = False,
                                  Optional ByVal sqlTrans As SqlTransaction = Nothing, Optional ByVal parameters As List(Of SqlParameter) = Nothing, Optional ByVal sqlcmd As Boolean = True)
    ...
    Public Sub PrepareCmdText(ByVal sql$, Optional ByVal Limitless As Boolean = False,
