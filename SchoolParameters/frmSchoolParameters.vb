...
Public Class frmSchoolParameters
    ...
    Private ExamGrades As List(Of cExamGrading)
  ...
  '      AutoStudIDCheckBox.CheckState = CheckState.Unchecked
    ...
    Private Sub ToolStripButton25_Click_1(sender As Object, e As EventArgs) Handles ToolStripButton25.Click
        ...
        Try
            ...
            With cmd
                ...
                .Parameters.AddWithValue("@parentexam", cboExamParentExam.Text)
                .ExecuteNonQuery()
    ...
    Private Sub DepsDataGridView_DataError(sender As Object, e As DataGridViewDataErrorEventArgs) Handles DepsDataGridView.DataError
        Try
